...
interface Set extends Collection, IteratorAggregate
{
     ...
     *
     * @param mixed $element The element to be added to this set
     *
     ...
     *
     * @param iterable<mixed> $elements The list of elements to be added to this collection
     *
     ...
     *
     * @param mixed $element The element whose presence in this set is to be tested
     *
     ...
     *
     * @param iterable<mixed> $elements The list of elements whose presence in this set is to be tested
     *
     ...
     *
     * @param mixed $element The element to remove from this set, if present
     *
     ...
     *
     * @param iterable<mixed> $elements The list of elements to be removed from this set
     *
